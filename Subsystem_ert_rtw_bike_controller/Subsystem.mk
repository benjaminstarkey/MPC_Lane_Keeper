...
## Generated on : Thu Jun 25 10:22:55 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Subsystem
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Subsystem
...
SRCS = $(START_DIR)/Subsystem_ert_rtw/Subsystem.cpp $(START_DIR)/Subsystem_ert_rtw/Subsystem_data.cpp $(START_DIR)/Subsystem_ert_rtw/rtGetInf.cpp $(START_DIR)/Subsystem_ert_rtw/rtGetNaN.cpp $(START_DIR)/Subsystem_ert_rtw/rt_nonfinite.cpp

MAIN_SRC = $(START_DIR)/Subsystem_ert_rtw/ert_main.cpp
...
OBJS = Subsystem.o Subsystem_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o
...
%.o : $(START_DIR)/Subsystem_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Subsystem.o : $(START_DIR)/Subsystem_ert_rtw/Subsystem.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Subsystem_data.o : $(START_DIR)/Subsystem_ert_rtw/Subsystem_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Subsystem_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Subsystem_ert_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Subsystem_ert_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Subsystem_ert_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
